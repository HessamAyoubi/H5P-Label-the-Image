...
// h5p.json (content-level manifest). For a bare library bundle you still
// need a minimal h5p.json so the H5P Hub / CLI can validate.
const h5pJson = {
...
// Empty content/content.json placeholder (authors replace this when they
// create an actual content package through the editor).
archive.append(JSON.stringify({
  taskDescription: 'Click each marker and type the name of the object.',
  points: [],
  behaviour: { enableRetry: true, enableSolutionsButton: true, enableCheckButton: true, acceptSpellingErrors: false, caseSensitive: false },
  overallFeedback: []
